...
ALLOWED_HOSTS = ['the-rescuers-p5.herokuapp.com', 'localhost']

APP_URL = 'https://the-rescuers-p5.herokuapp.com/'
...
ROOT_URLCONF = 'the_rescuers.urls'
...
WSGI_APPLICATION = 'the_rescuers.wsgi.application'
